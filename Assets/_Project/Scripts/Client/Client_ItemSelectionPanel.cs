...
public sealed class Client_ItemSelectionPanel : MonoBehaviour
{
    private const int CandidateCount = 3;

    [SerializeField] private TextMeshProUGUI itemTypeText;
    [SerializeField] private Image timerFillImage;
    [SerializeField] private Client_ItemSelectionSlot[] optionSlots = new Client_ItemSelectionSlot[CandidateCount];
    ...
    {
        Client_ItemSelectionSlot slot = GetSlot(index);
        if (slot != null)
        {
    ...
    public void SetButtonsInteractable(bool interactable)
    {
        ...
        {
            Client_ItemSelectionSlot slot = optionSlots[i];
            if (slot != null)
            {
    ...
    private Client_ItemSelectionSlot GetSlot(int index)
    {
        EnsureSlots();
    ...
    private void EnsureSlots()
    {
        ...
        {
            optionSlots = new Client_ItemSelectionSlot[CandidateCount];
        }
    }
}
